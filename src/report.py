...
class Report(object):
    def __init__(self, csv_dir, package):
        self.summary_csf_file = {"cpu.csv": {"table_name": "cpu",
                                 ...
                                 "pss_top.csv": {"table_name": "pss_top",
                                                 "x_axis": "datetime",
                                                 "y_axis": "mem(MB)",
                                                 "values": ["pss", "total"]
                                                 },
                                 ...
                                 "network.csv": {"table_name": "network",
                                                 "x_axis": "datetime",
                                                 "y_axis": "time(MS)",
                                                 "values": ["total"]
                                                 },
                                 "start.csv": {"table_name": "start",
                                               "x_axis": "datetime",
                                               "y_axis": "time(MS)",
                                               "values": ["ttfd"]
                                               }
        ...
        if file_names:
            ...
            for file_name in file_names:
                ...
                try:
                    ...
                    logger.error(f"处理文件 {file_name} 出错：{e}")
...
if __name__ == '__main__':
    result_dir = r'D:\pythoncode\AdbTool\dist\adbtool\_internal\results\com.hunantv.market\2025_07_04_19_17_46_25070417'
    r = Report(result_dir, 'com.hunantv.market')
